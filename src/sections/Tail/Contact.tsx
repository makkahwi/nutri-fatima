  ...
  >
    <div className="contact-layout">
      <div className="contact-intro">
        ...
        <p>
          للتواصل مع فاطمة محمد، أخصائية تغذية في الأردن، احكِ لي عن أهدافك
          وتجاربك. نراجع عاداتك ووضعك الصحي معًا، ونبني خطة تناسبك. للاستفسار
          عن استشارات التغذية أو حجز موعد، راسلني عبر واتساب أو البريد الإلكتروني.
        </p>
