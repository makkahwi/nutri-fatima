    ...
    >
      <div className="col-md-12 content-panel">
        ...
        <h5 className="text-justify lh-lg text-success my-5">
          خلال أكثر من {new Date().getFullYear() - 2019} سنوات، عملت مع مئات
          المراجعين على أهداف مختلفة: خسارة الوزن، زيادة الوزن بشكل صحي، تحسين
          المؤشرات الصحية، وبناء علاقة أهدأ مع الطعام. هدفي أن نصل إلى نتيجة
          مستدامة تناسب أسلوب حياتك، دون حرمان أو ضغط زائد.
        </h5>
